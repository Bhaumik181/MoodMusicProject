...
def main():
    ...
    plt.ylabel("True")
    plt.title("Confusion Matrix - FER2013 Emotion Model (v2)")
    plt.tight_layout()
    plt.show()
    ...
    # Save as v2
    save_path = os.path.join(MODELS_DIR, "emotion_model_v2.h5")
    model.save(save_path)
    print("\nModel v2 saved to:", save_path)
